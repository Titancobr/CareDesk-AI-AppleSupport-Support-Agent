#!/bin/bash
# AppleSupport Customer Service Agent Startup Script

# 1. Start the AppleSupport FastAPI backend in the background
# The Streamlit UI connects to this via http://localhost:8000
