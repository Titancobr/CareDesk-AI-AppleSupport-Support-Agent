...
> 📄 **Official Clean 6-Page PDF Evaluation Report:** [caredesk_ai_evaluation_report.pdf](caredesk_ai_evaluation_report.pdf)  
> 📋 **15 Engineering Decisions Rationale:** [DECISION_LOG.md](DECISION_LOG.md) · 🏛️ **System Architecture:** [ARCHITECTURE.md](ARCHITECTURE.md)
...
## Supplementary Screenshots & Figures

The following figures document the evaluation workflow and product experience described in this report. All images are stored within `assets/images/` for full repository portability and visibility on GitHub.

### Figure 1: AppleCare Intelligence & Genius Bar Diagnostics Dashboard
![AppleCare Intelligence dashboard](assets/images/fig1_dashboard_focus.png)

*Figure 1. Active Qdrant cluster connectivity (`hiver_support_history`), NeMo safety guardrails status, and operational modules.*

### Figure 2: Ground-Truth Golden Test Suite View
![Ground-truth dataset view](assets/images/fig2_ground_truth_focus.png)

*Figure 2. Evaluation suite view of the 200-example golden test dataset (175 stratified RAG questions + 25 adversarial guardrails).*

### Figure 3: Live Pipeline Execution & Token Collection
![Live pipeline view](assets/images/fig3_pipeline_focus.png)

*Figure 3. Live pipeline streaming golden questions against the local FastAPI `/query` endpoint and capturing real response tokens.*

### Figure 4: Agent Thought Process Trail & Decision Logic
![Thought trail with verified citations](assets/images/fig4_thought_trail_focus.png)

*Figure 4. Structured agent thought trail showing intent classification (92% confidence), auto-handle disposition, and verified citation binding.*

### Figure 5: Interactive Diagnostic Response with Apple SOP Attribution
![Diagnostic response](assets/images/fig5_chat_response_focus.png)
